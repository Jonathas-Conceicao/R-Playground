...
nesta Seção apresentamos na Tabela \ref{tab1} e \ref{tab2} médias dos valores numéricos estimados para população.
...
Assim como pode ser visto na Tabela \ref{tab3}, ao nível de $5\%$ de significância, os valores observados não diferem significativamenta um do outro. Portanto, não há motivos para crer que o quanto maior tempo de uso do smartphone menor é a prática de atividades físicas. Assim como pelo mesmo motivo, não é possível concluir que quanto maior o número de disciplinas cursadas há mais desistência do curso.

\begin{table}[h]
\centering
\begin{tabular}{l|c|c|c}
\hline
\multicolumn{1}{c|}{Variável 1}                                          & Variável 2                                                                   & Valor-P & Conclusão                                                        \\ \hline
\begin{tabular}[c]{@{}l@{}}Já pensou em\\ desistir do curso\end{tabular} & \begin{tabular}[c]{@{}c@{}}Quantidade de\\ disciplinas cursadas\end{tabular} & 0.4936  & \begin{tabular}[c]{@{}c@{}}Dados não\\ relacionadas\end{tabular} \\ \hline
\begin{tabular}[c]{@{}l@{}}Pratica alguma\\ atividade física\end{tabular} & \begin{tabular}[c]{@{}c@{}}Tempo médio de uso diário\\ do smartphone\end{tabular} & 0.4936  & \begin{tabular}[c]{@{}c@{}}Dados não\\ relacionadas\end{tabular} \\ \hline
\end{tabular}
\caption{Teste Qui-quadrado para correlação}
\label{tab3}
\end{table}
