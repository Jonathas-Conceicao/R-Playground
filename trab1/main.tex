...
\label{tab3}
\end{table}
Concluímos, ao nível de $5\%$ de significância, que os valores observados não diferem significativamenta um do outro. Portanto, não há motivos para concluir que o quanto maior tempo de uso do smartphone menor é a prática de atividades físicas. Assim como pelo mesmo motivo, não é possível concluir que quanto maior o número de disciplinas cursadas há mais desistência do curso.
\clearpage
